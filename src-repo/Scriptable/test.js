...
async function createWidget() {
  ...
  currentData.slice(0, 4).forEach((p, i) => {
    ...
    canvas.size = new Size(100, 130); // 增加画布高度以容纳岁数
    ...
    canvas.drawTextInRect(`今年 ${age} 岁`, new Rect(0, arcCenterY + 28, 100, 12));

    const img = col.addImage(canvas.getImage());
    img.imageSize = new Size(75, 98); 
