...
const countryList = [
  ...
  { enShort: "DO", enShort3: "DOM", zh: "多米尼加共和国", enFull: "Dominican Republic", emoji: "🇩🇴", alias: ["SDQ⚡TG@danfeng_chat"] },
  ...
  { enShort: "LV", enShort3: "LVA", zh: "拉脱维亚", enFull: "Latvia", emoji: "🇱🇻", alias: ["RIX⚡TG@danfeng_chat"] },
  ...
  { enShort: "US", enShort3: "USA", zh: "美国", enFull: "United States", emoji: "🇺🇸", alias: ["SCI⚡TG@danfeng_chat","TPA⚡TG@danfeng_chat", "EWR⚡TG@danfeng_chat", "US⚡TG@danfeng_chat", "LAX", "SJC", "Chicago", "Los Angeles", "New York", "NewYork", "San Jose", "西雅图", "阿什本", "USA"] },
