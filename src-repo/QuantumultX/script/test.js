...
const map = {
  "費":"费","韋":"韦","寧":"宁","薩":"萨","濟":"济","橋":"桥","魯":"鲁","溫":"温","區":"区",
  "奧":"奥","羅":"罗","爾":"尔","縣":"县","蘭":"兰","華":"华","壢":"坜","裏":"里","約":"约",
  "熱":"热","內":"内","盧":"卢","萬":"万","與":"与","專":"专","業":"业","東":"东","絲":"丝",
  "丟":"丢","兩":"两","嚴":"严","喪":"丧","個":"个","豐":"丰","臨":"临","為":"为","麗":"丽",
  "舉":"举","麼":"么","義":"义","烏":"乌","樂":"乐","喬":"乔","習":"习","鄉":"乡","書":"书",
  "買":"买","亂":"乱","爭":"争","於":"于","虧":"亏","雲":"云","亞":"亚","產":"产","畝":"亩",
  "親":"亲","億":"亿","價":"价","儀":"仪","優":"优","會":"会","傴":"伛","偉":"伟","傳":"传",
  "傷":"伤","倫":"伦","偽":"伪","體":"体","佇":"伫","佈":"布","佔":"占","協":"协","單":"单",
  "衛":"卫","卻":"却","廠":"厂","歷":"历","參":"参","雙":"双","發":"发","變":"变","叢":"丛",
  "台":"台","葉":"叶","後":"后","員":"员","問":"问","國":"国","圖":"图","圍":"围","園":"园",
  "團":"团","壞":"坏","壩":"坝","壯":"壮","聲":"声","壺":"壶","處":"处","備":"备","復":"复",
  "夠":"够","夢":"梦","奪":"夺","奮":"奋","婦":"妇","絕":"绝","愛":"爱","觀":"观","訴":"诉",
  "尋":"寻","導":"导","對":"对","屬":"属","岡":"冈","島":"岛","崗":"岗","峽":"峡","嶺":"岭",
  "嶽":"岳","巖":"岩","幣":"币","廣":"广","廳":"厅","應":"应","廟":"庙","庫":"库","廢":"废",
  "開":"开","張":"张","彈":"弹","強":"强","歸":"归","當":"当","錄":"录","彙":"汇","懷":"怀",
  "總":"总","戰":"战","戶":"户","撥":"拨","擴":"扩","擇":"择","擊":"击","擠":"挤","擁":"拥",
  "擬":"拟","擾":"扰","敵":"敌","數":"数","斷":"断","時":"时","晉":"晋","曆":"历","朧":"胧",
  "極":"极","標":"标","榮":"荣","構":"构","樣":"样","樸":"朴","樹":"树","機":"机","橫":"横",
  "檔":"档","檢":"检","歡":"欢","歲":"岁","歐":"欧","殘":"残","殼":"壳","毆":"殴","氣":"气",
  "漢":"汉","沒":"没","災":"灾","無":"无","煉":"炼","煙":"烟","燦":"灿","營":"营","爐":"炉",
  "爛":"烂","爺":"爷","牆":"墙","牽":"牵","犧":"牺","狀":"状","獨":"独","現":"现","環":"环",
  "畫":"画","瘋":"疯","盜":"盗","盞":"盏","盡":"尽","監":"监","盤":"盘","矯":"矫","礎":"础",
  "禍":"祸","禪":"禅","禮":"礼","稅":"税","穎":"颖","穩":"稳","窩":"窝","簡":"简","糧":"粮",
  "糾":"纠","紀":"纪","純":"纯","紐":"纽","級":"级","納":"纳","紙":"纸","紛":"纷","終":"终",
  "組":"组","經":"经","結":"结","給":"给","統":"统","綠":"绿","維":"维","緊":"紧","線":"线",
  "編":"编","練":"练","縮":"缩","績":"绩","繼":"继","繩":"绳","繪":"绘","繫":"系","纖":"纤",
  "聖":"圣","聞":"闻","聯":"联","聰":"聪","職":"职","腦":"脑","腳":"脚","臉":"脸","舊":"旧",
  "興":"兴","艦":"舰","藝":"艺","蔣":"蒋","藍":"蓝","蘇":"苏","號":"号","虛":"虚","視":"视",
  "訓":"训","評":"评","詞":"词","詩":"诗","誌":"志","認":"认","誕":"诞","語":"语","誠":"诚",
  "調":"调","談":"谈","請":"请","論":"论","諸":"诸","諾":"诺","讀":"读","貓":"猫","貝":"贝",
  "負":"负","財":"财","貨":"货","販":"贩","責":"责","貴":"贵","貿":"贸","賀":"贺","資":"资",
  "賓":"宾","賞":"赏","賣":"卖","賠":"赔","賬":"账","質":"质","賴":"赖","贊":"赞","贈":"赠",
  "贏":"赢","趙":"赵","趨":"趋","跡":"迹","車":"车","軋":"轧","軍":"军","軌":"轨","軒":"轩",
  "軟":"软","較":"较","載":"载","輕":"轻","輩":"辈","輪":"轮","輯":"辑","輻":"辐","轉":"转",
  "農":"农","邊":"边","達":"达","遞":"递","遠":"远","適":"适","選":"选","遲":"迟","遼":"辽",
  "醫":"医","釋":"释","鑄":"铸","鎮":"镇","鐘":"钟","鐵":"铁","鑽":"钻","長":"长","門":"门",
  "閣":"阁","閱":"阅","隊":"队","陽":"阳","陰":"阴","際":"际","險":"险","雜":"杂","電":"电",
  "預":"预","頗":"颇","領":"领","頭":"头","頻":"频","題":"题","額":"额","風":"风","飛":"飞",
  "餐":"餐","馬":"马","駕":"驾","駛":"驶","騎":"骑","驗":"验","高":"高","鳳":"凤","鷹":"鹰",
  "鳥":"鸟","鹽":"盐","黃":"黄","黑":"黑","點":"点","齒":"齿","龍":"龙","灣":"湾","臺":"台",
  "滙":"汇","滙豐":"汇丰"
};
...
function t2s(str) {
  if (!str) return "";
  return str.replace(regex, (char) => map[char] || char);
}
...
const countryMap = { "中華民國":"中国", "中华民国":"中国", "俄罗斯联邦":"俄罗斯", "德意志联邦共和国":"德国", "象牙海岸":"科特迪瓦", "Libya":"利比亚", "South Korea":"韩国" };
const regionMap = {
    ...
    // BA - 波黑 - Bosnia and Herzegovina - 南欧/巴尔干半岛 - Southern Europe/Balkans
    "Federation of Bosnia and Herzegovina":"波黑联邦",
    ...
    // QA - 卡塔尔 - Qatar - 中东 - Middle East
    "Baladīyat ad Dawḩah": "多哈自治市",
...
function Country_check(para) {
  return countryMap[para ? para.trim() : ""] || para || "";
}

function Region_check(para) {
  return regionMap[para ? para.trim() : ""] || para || "";
}

function City_check(para) {
  return cityMap[para ? para.trim() : ""] || para || "";
}
...
let finalCity = (city === country) ? '' : city;
