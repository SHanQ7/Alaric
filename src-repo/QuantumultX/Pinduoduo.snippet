...
^https:\/\/api\.pinduoduo\.com\/search url json-response-body 'del(.expansion)'
^https:\/\/api\.pinduoduo\.com\/api\/philo\/personal\/hub url json-response-body 'del(.monthly_card_entrance, .personal_center_style_v2_vo, .icon_set.icons, .icon_set.top_personal_icons)'
^https:\/\/api\.pinduoduo\.com\/api\/oak\/integration\/render url json-response-body 'del(.bottom_section_list, .ui.bottom_section, .ui.live_section.float_info)'
^https:\/\/api\.pinduoduo\.com\/api\/caterham\/v3\/query\/order_detail_group url json-response-body 'del(.data.goods_list)'
